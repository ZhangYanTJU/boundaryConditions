...
#include "decayingTurbulenceFvPatchVectorField_ZY.H"
#include "volFields.H"
...
Foam::decayingTurbulenceFvPatchVectorField_ZY::decayingTurbulenceFvPatchVectorField_ZY
(
    const fvPatch& p,
...
Foam::decayingTurbulenceFvPatchVectorField_ZY::decayingTurbulenceFvPatchVectorField_ZY
(
    const decayingTurbulenceFvPatchVectorField_ZY& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
    ...
    Radius_(0)
{
    ...
    forAll(RField_, I)
    {
        ...
        FatalErrorIn("decayingTurbulenceFvPatchVectorField_ZY::")<< "Some RMS are negative in R"<<abort(FatalError);
    }
...
void Foam::decayingTurbulenceFvPatchVectorField_ZY::autoMap(const fvPatchFieldMapper& m)
{
...
void Foam::decayingTurbulenceFvPatchVectorField_ZY::rmap(const fvPatchField<vector>& ptf, const labelList& addr)
{
    fixedValueFvPatchField<vector>::rmap(ptf, addr);

    const decayingTurbulenceFvPatchVectorField_ZY& tiptf = refCast<const decayingTurbulenceFvPatchVectorField_ZY>(ptf);
...
void Foam::decayingTurbulenceFvPatchVectorField_ZY::updateCoeffs()
{
...
void Foam::decayingTurbulenceFvPatchVectorField_ZY::readInletData()
{
}

void Foam::decayingTurbulenceFvPatchVectorField_ZY::writeSourceFields()
{
}

void Foam::decayingTurbulenceFvPatchVectorField_ZY::doUpdate()
{
...
void Foam::decayingTurbulenceFvPatchVectorField_ZY::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchVectorField,
        decayingTurbulenceFvPatchVectorField_ZY
    );
}
